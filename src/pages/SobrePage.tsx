...
const milestones = [
  ...
  },
  {
    ...
    title: "Multi-modelo",
    description:
      "Desenvolvemos nossa infraestrutura para consultar simultaneamente OpenAI, Gemini e Google Modo IA. Cada modelo &quot;pensa&quot; diferente — entender todos é a única forma de mapear a verdadeira percepção da marca.",
    icon: Zap,
