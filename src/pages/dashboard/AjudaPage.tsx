...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: "O Score (0–100) mede a presença e a qualidade com que sua marca aparece nas IAs (ChatGPT, Gemini e Google Modo IA com grounding do Google em tempo real). É composto por 5 pilares — Clareza, Autoridade, Conversão, Posicionamento e Relevância — cada um com 3 sub-critérios ponderados. Faixas: 0–39 Crítico, 40–59 Insuficiente, 60–74 Moderado, 75–89 Sólido, 90–100 Referência.",
  },
  {
