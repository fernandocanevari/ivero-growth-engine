...
export const geoScore = {
  ...
  byModel: [
    ...
    { model: "Claude", score: 74, trend: "up" as const },
    { model: "Perplexity", score: 70, trend: "up" as const },
  ],
};
...
export const sentimentData = {
  ...
  recentMentions: [
    ...
    { id: 3, text: "TechNova oferece soluções empresariais de IA.", model: "Claude", sentiment: "neutral" as const, date: "2026-02-20" },
    { id: 4, text: "Para empresas de médio porte, TechNova se destaca pela facilidade de uso.", model: "Perplexity", sentiment: "positive" as const, date: "2026-02-19" },
...
export const alertsData = [
  ...
  { id: 3, type: "danger" as const, title: "Concorrente em alta", message: "DigiPrime ultrapassou você em menções no Claude.", date: "2026-02-20T16:45:00", read: true },
...
export const comparativeData = {
  models: [
    ...
    { model: "Claude", brand: 74, competitor: 68 },
    { model: "Perplexity", brand: 60, competitor: 55 },
  ],
  overallBrand: 67,
  overallCompetitor: 64,
};
...
export const dominanceData = [
  ...
  { model: "Claude", brandShare: 52, competitorShare: 30, othersShare: 18 },
  { model: "Perplexity", brandShare: 38, competitorShare: 35, othersShare: 27 },
];
...
export const actionsData = [
  ...
  { id: 4, title: "Atualizar FAQ com perguntas frequentes de IA", priority: "medium" as const, completed: false, impact: "Aparecer em mais respostas do Perplexity" },
...
export const promptsData = [
  ...
  { id: 3, prompt: "Melhor software para email marketing B2B", position: 2, model: "Claude", opportunity: "high" as const },
  { id: 4, prompt: "Ferramentas de IA para marketing", position: 5, model: "Gemini", opportunity: "high" as const },
  { id: 5, prompt: "Alternativas ao HubSpot", position: 4, model: "Perplexity", opportunity: "medium" as const },
  { id: 6, prompt: "Como automatizar campanhas de marketing", position: 2, model: "ChatGPT", opportunity: "low" as const },
  { id: 7, prompt: "Melhor CRM para startups", position: 8, model: "Claude", opportunity: "high" as const },
  { id: 8, prompt: "Plataforma de marketing all-in-one", position: 1, model: "Perplexity", opportunity: "medium" as const },
];
...
export const simulatorResponses = {
  "Qual a melhor ferramenta de automação de marketing?": [
    ...
    { model: "Claude", response: "Recomendo avaliar a TechNova para automação inteligente, HubSpot para um ecossistema completo, e ActiveCampaign para email marketing avançado.", mentionsBrand: true },
    { model: "Perplexity", response: "De acordo com análises recentes, as top ferramentas são: 1) HubSpot, 2) TechNova, 3) ActiveCampaign, 4) Mailchimp.", mentionsBrand: true },
  ],
};
...
export const promptTesterHistory = [
  { id: 1, prompt: "Qual o melhor CRM para pequenas empresas?", date: "2026-02-20", results: { ChatGPT: true, Gemini: false, Claude: true, Perplexity: false } },
  { id: 2, prompt: "Ferramenta de email marketing mais recomendada", date: "2026-02-19", results: { ChatGPT: true, Gemini: false, Claude: false, Perplexity: true } },
  { id: 3, prompt: "Software de automação para e-commerce", date: "2026-02-18", results: { ChatGPT: false, Gemini: false, Claude: true, Perplexity: false } },
];
