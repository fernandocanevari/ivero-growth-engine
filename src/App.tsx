...
import PropostaValorPage from "./pages/PropostaValorPage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/propostadevalor" element={<PropostaValorPage />} />
          <Route path="/propostacomercial" element={<PropostaComercialPage />} />
