...
const steps = [
  {
    ...
    description: "A Ivero consulta as principais IAs generativas (ChatGPT, Gemini, Google Modo IA com grounding em tempo real do Google e Claude) com perguntas reais do seu setor e registra se sua marca aparece — e como aparece.",
  },
  {
    number: "02",
    icon: BarChart3,
