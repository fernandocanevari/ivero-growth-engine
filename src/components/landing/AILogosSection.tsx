...
const AILogosSection = () => {
  ...
  return (
    <section className="py-10 bg-gradient-to-r from-[hsl(330,25%,8%)] via-[hsl(330,30%,11%)] to-[hsl(330,25%,8%)] border-y border-[hsl(330,40%,25%/0.3)] overflow-hidden">
      ...
      <div className="relative">
        {/* Fade edges */}
        <div className="absolute left-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-r from-[hsl(330,25%,8%)] to-transparent pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-l from-[hsl(330,25%,8%)] to-transparent pointer-events-none" />
